...
namespace MultiTrackQTMovie {
    ...
    private:
        ...
        void setString(std::string str, unsigned int length=4) {
            ...
            if(len>=1) {
                while(len--) [this->bin appendBytes:new unsigned char[1]{0} length:1];
            }
    #endif
        }
        ...
        public:
            ...
            void save() {
                ...
                if(this->_isRunning&&!this->_isRecorded) {
                    ...
                    Moov *moov = new Moov(this->_info,this->_frames,this->_chunks,this->_keyframes,(unsigned char *)[this->_sps bytes],[this->_sps length],(unsigned char *)[this->_pps bytes],[this->_pps length]);
